...
class BatchCreatingFrame(Frame):
    ...
    def __create_widgets(self):
        self.batch_create_label = Label(self, text="Queries de Casos de Test")
        self.batch_create_text_box = Text(self, height=15, width=65)
        
        ToolTip(self.batch_create_text_box, msg="Aquí puede escribir queries que usarán el programa cargado para crear una batería de tests. Cada test diferente tiene que estar separada con un fin de linea (enter). Ej: \ndia(miercoles).\ndia(X).", delay=1.0)
