...
class StudentView(View):
    ...
    def __create_widgets(self, root):
        self._upper_side_frame = HeaderFrame(root, width=800, height=50, pady=3, padx=10, functions=(self._load_knowledge_base, self._test_mode, self._manual_create_mode))
